...
// FSJS project 3 - Interactive Form Study Guide
// ******************************************/
...
$(document).ready(function() {
 ...
 $('form').submit(function (e){
   ...
   if ( $('#name').val() === "" ) {
     ...
     errorMessage = "<h2>Error!</h2> Please ensure you have entered a name."; // Extra credit
     ...
     $("html, body").animate({scrollTop: 0}, "slow");
       errorMessage = "<h2>Error!</h2> Please enter a valid email."; // Extra credit
       errorMessage = errorMessage.fontcolor("red"); // Extra credit
